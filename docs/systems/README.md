...
- [`NUTRITION_SPEC.md`](NUTRITION_SPEC.md) — питание, голод и сытость.
- [`ACTION_EFFECT_COOLDOWNS_SPEC.md`](ACTION_EFFECT_COOLDOWNS_SPEC.md) — кулдауны восстановительных эффектов.
